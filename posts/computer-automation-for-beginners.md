...
[Flyto2](https://flyto2.com) is a free automation tool that runs on your own computer. It comes with 452 ready-to-use building blocks (called modules) that handle common tasks — opening web pages, moving files, processing data, and more.
...
Computer automation doesn't have to be complicated. [Flyto2](https://flyto2.com) gives you everything you need to start — 452 modules, simple YAML workflows, and zero cost. Install it today, automate your first task, and see the difference for yourself.
