...
1. Opens the HR portal
2. Filters requests by "Pending"
3. Opens each request
4. Clicks "Approve" (for pre-approved categories)
...
1. **Be specific about what to click** — "Click the blue Submit button at the bottom of the form" works better than "click Submit"
2. **Account for loading time** — Websites do not respond instantly. Good automation waits for the page to be ready before clicking
3. **Handle pop-ups** — Cookie banners, notification prompts, and modal dialogs can block clicks. Flyto2 handles these automatically
4. **Test on one item first** — Before running your workflow on 100 items, test it on one to make sure it clicks the right things
5. **Review the evidence** — Flyto2 captures screenshots at every step. Check them to confirm the automation is working correctly
