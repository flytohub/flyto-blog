...
And it is the same execution substrate throughout. The deterministic engine that powers our automation product line ([flyto-core](https://docs.flyto2.com/): 412+ deterministic modules, MCP-native, YAML recipes, evidence and replay) is literally what runs the footprint expansion, collects the per-entity evidence, and drives the downstream pentest and red-team. Automation is the *how*; the war-room is the *what and why*.
