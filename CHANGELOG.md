...
- Upgraded rendered videos with a live public Flyto2 product recording,
  ...
  transitions, generated ambient audio, burned captions with reserved content
  bands, separate responsive product recordings for each ratio, and one
  final-video verification frame per scene and output ratio.
